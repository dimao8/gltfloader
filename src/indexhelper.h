...
private:
  ...
  const size_t &m_texture_info_defaults_size;
  const std::vector<std::shared_ptr<GLTFTextureInfo> > &m_texture_infos;
...
public:
  ...
  size_t accessor_defaults_size () const;
  size_t animations_size () const;
  size_t animation_defaults_size () const;
  size_t buffers_size () const;
  size_t buffer_defaults_size () const;
  size_t buffer_views_size () const;
  size_t buffer_view_defaults_size () const;
  size_t cameras_size () const;
  size_t camera_defaults_size () const;
  size_t images_size () const;
  size_t image_defaults_size () const;
  size_t materials_size () const;
  size_t material_defaults_size () const;
  size_t meshes_size () const;
  size_t mesh_defaults_size () const;
  size_t nodes_size () const;
  size_t node_defaults_size () const;
  size_t default_texture_sampler_index () const;
  size_t samplers_size () const;
  size_t sampler_defaults_size () const;
  size_t scenes_size () const;
  size_t scene_defaults_size () const;
  size_t skins_size () const;
  size_t skin_defaults_size () const;
  size_t textures_size () const;
  size_t texture_defaults_size () const;
